...
|---|---|---:|---|---:|---:|---:|---:|
| transformer tuned | transformer | - | success | 81.93 | 16.39 | 2074.00 | 40.74 |
| size-50M smoke | size | 50000000 | success | 78.13 | 15.62 | 2132.79 | 26.81 |
...
- Throughput-oriented config: transformer-layer auto-wrap + backward_prefetch=None + limit_all_gathers=True.
  - This gives the best 50-step throughput in the tested search space.

- Memory-oriented config: size-based auto-wrap with min_num_params=100M + backward_prefetch=None + limit_all_gathers=True.
  - This reduces peak memory from about 40.74 GiB to about 26.81 GiB, a reduction of about 34.2%, at the cost of about 4.3% lower average tokens/sec.
